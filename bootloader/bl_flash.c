...
//
//*****************************************************************************
void BLInternalFlashErase(uint32_t ui32Address)
{
    //
...
//
//*****************************************************************************
void BLInternalFlashProgram(uint32_t ui32DstAddr, uint8_t *pui8SrcData,
                       uint32_t ui32Length)
{
    uint32_t ui32Loop;
...
//
//*****************************************************************************
uint32_t BLInternalFlashStartAddrCheck(uint32_t ui32Addr, uint32_t ui32ImgSize)
{
