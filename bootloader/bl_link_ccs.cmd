...
MEMORY
{
    FLASH (RX) : origin = 0x00000000, length = 0x00002800  /* Bootloader uses 10 KB (0x2800) */
...
SECTIONS
{
    ...
    /* Added .text:decompress and .cinit sections */
    .text:decompress > FLASH
    .text:decompress:ZI > FLASH
    .text:decompress:ZI:__TI_zero_init_nomemset > FLASH
    .cinit > FLASH
    /* Explicitly place runtime-support library's memset routine */
    .text.memset > FLASH
}
